...
function PopChild({ children, isPresent: isPresent2 }) {
  const id4 = (0, import_react4.useId)();
  const ref = (0, import_react4.useRef)(null);
  const size = (0, import_react4.useRef)({
    width: 0,
    height: 0,
    top: 0,
    left: 0
  });
  const { nonce } = (0, import_react4.useContext)(MotionConfigContext);
...
var PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode }) => {
  ...
  const memoizedOnExitComplete = (0, import_react5.useCallback)((childId) => {
...
var AnimatePresence = ({ children, exitBeforeEnter, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync" }) => {
  ...
  const presentChildren = (0, import_react9.useMemo)(() => onlyElements(children), [children]);
  const presentKeys = presentChildren.map(getChildKey);
  const isInitialRender = (0, import_react9.useRef)(true);
  const pendingPresentChildren = (0, import_react9.useRef)(presentChildren);
  const exitComplete = useConstant(() => /* @__PURE__ */ new Map());
  const [diffedChildren, setDiffedChildren] = (0, import_react9.useState)(presentChildren);
  const [renderedChildren, setRenderedChildren] = (0, import_react9.useState)(presentChildren);
  ...
  const { forceRender } = (0, import_react9.useContext)(LayoutGroupContext);
...
var DeprecatedLayoutGroupContext = (0, import_react10.createContext)(null);
...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react12.useState)(0);
  const forceRender = (0, import_react12.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react12.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
var LayoutGroup = ({ children, id: id4, inherit = true }) => {
  const layoutGroupContext = (0, import_react13.useContext)(LayoutGroupContext);
  const deprecatedLayoutGroupContext = (0, import_react13.useContext)(DeprecatedLayoutGroupContext);
  const [forceRender, key] = useForceUpdate();
  const context = (0, import_react13.useRef)(null);
  ...
  const memoizedContext = (0, import_react13.useMemo)(() => ({ ...context.current, forceRender }), [key]);
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react15.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react15.useRef)(void 0);
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  config = { ...(0, import_react16.useContext)(MotionConfigContext), ...config };
  config.isStatic = useConstant(() => config.isStatic);
  const context = (0, import_react16.useMemo)(() => config, [
...
function useCreateMotionContext(props) {
  const { initial, animate: animate2 } = getCurrentTreeVariants(props, (0, import_react18.useContext)(MotionContext));
  return (0, import_react18.useMemo)(() => ({ initial, animate: animate2 }), [variantLabelsAsDependency(initial), variantLabelsAsDependency(animate2)]);
}
...
function usePresence() {
  ...
  const id4 = (0, import_react27.useId)();
  (0, import_react27.useEffect)(() => register(id4), []);
  const safeToRemove = (0, import_react27.useCallback)(() => onExitComplete && onExitComplete(id4), [id4, onExitComplete]);
